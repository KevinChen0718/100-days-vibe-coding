...
| 004 | 小朋友齊打交・致敬復刻版 | 復刻 LF2 核心手感的 2.5D 格鬥遊戲：縱深對齊命中、雙擊跑步、三連擊、防禦、「防→前→攻」搓招放波，加上撿武器（球棒/小刀/石頭/汽水從天而降）、2v2 群架（4 種模式）、雙倍寬捲軸戰場（三層視差）。4 隻原創角色，全 Canvas 向量手繪 + WebAudio 合成音效與戰鬥 BGM、零依賴。 | [day-004-little-fighter](day-004-little-fighter/) |
