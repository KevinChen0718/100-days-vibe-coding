# Day 4 — 小朋友齊打交・原創角色版 Little Fighters Original Roster
...
復刻童年經典《小朋友齊打交》(Little Fighter 2):2.5D 縱深格鬥、雙擊跑步、三連擊、防禦、搓招放波,加上 LF2 三寶——**撿武器**(球棒/小刀/石頭/汽水從天而降)、**2v2 群架**(共 4 種模式)、**場景捲軸**(兩個螢幕寬的戰場 + 三層視差)。場景由 Canvas 繪製,五位角色使用自製透明 Sprite Atlas,音效和戰鬥 BGM 由 WebAudio 即時合成。
...
**第四版「Original Roster」**:五位玩家角色改為完全原創的 **ROOK / VEX / SHADE / EMBER / RIME**,每位角色都有 12 姿勢透明 Sprite Atlas。招式機制與平衡數值維持不變,但名稱、設定、人物輪廓、臉、服裝與動畫呈現全部自創；舊角色 ID 僅保留為測試與舊連結的相容映射。
...
- 怎麼跑:在專案根目錄啟動本機 HTTP server 後開啟 `day-004-little-fighter/`
...
- 引擎測試:`node test/sim.js`(5×5 組合互打 + 2v2 + 招式表逐招驗證 + 抓投/受身/武器 + Sprite Atlas + 回歸案例);AI 行為探針:`node test/probe.js rook ember [--2v2]`

| 標題 | 原創角色選角 | 競技場 2v2 |
|---|---|---|
| ![標題](screenshots/original-roster-title.jpeg) | ![選角](screenshots/original-roster-select.jpeg) | ![2v2](screenshots/original-roster-2v2.jpeg) |
